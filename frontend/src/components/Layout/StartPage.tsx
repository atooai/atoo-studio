  ...
  return (
    <div className="start-page" id="start-page">
      <div className="start-page-inner">
        <div className="start-logo">VCC</div>
        <div className="start-subtitle">Vibe Coding Command Center</div>
        <div className="start-label">Select Environment</div>
        <div className="start-grid">
          {environments.map(env => (
            <div key={env.id} className="start-card" onClick={() => (window as any).navigate('/vccenv/' + env.id)}>
